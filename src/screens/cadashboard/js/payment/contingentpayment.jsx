...
export default class Payment extends Component{
    ...
    render()
    {   
        let {isCouponValid,isPayed,registrationFee,couponDiscount,couponDiscountPayed,visibleAccomodationFee,noOfMembers,totalFee,discountAvailedPercent,couponDiscountPercent,totAmtPayed,datePayed} = this.state
            ...
            <div className="capayment-parent">
                 ...
                 <div className="capayment-paymentinfo">
                    ...
                    Contingent Registration
                     ...
                     <div className="capayment-spaceaboutcolon">Accomodation Fee <button id="capayment-toggleaccomodation" className="capayment-toggleaccomodation" onClick={(e)=>this.toggleAccomodation(e)}>DISCARD</button>   </div> :<div className="capayment-space"></div><div id='capayment-accomodationfee-toggle'>Rs {visibleAccomodationFee}</div><div className='capayment-noOfMembers' id='capayment-noOfMembers'>x{noOfMembers}</div>
                     </div>
