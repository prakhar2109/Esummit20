...
export default class Payment extends Component{
    ...
    render()
    {   
        let {isCouponValid,isPayed,registrationFee,workshops,noOfWorkshops,visibleAccomodationFee,noOfMembers,totalFee,couponDiscount,couponDiscountPayed,couponDiscountPercent,totAmtPayed,datePayed} = this.state
        ...
        // let totalamtPayed = registrationFeePayed+visibleAccomodationFeePayed-discountAvailedPayed-couponDiscountPayed
            ...
            <div className="capayment-parent">
             ...
             <div className="capayment-modalparent">
                ...
                <span className="capaymentwv-span">Payment Status</span> : Pending
                 ...
                 <div className='capayment-feesleader-only'>
                         Workshop fees can only be payed after contingent leader has paid the registration fees
                     </div>
                    ...
                    <div className='capaymentwv-totlamt'>
                        <div className="capaymentwv-spaceaboutcolon-total">Total Amount</div> :<div className="capaymentwv-space"></div>Rs&nbsp;800
                        {/* totalAmount */}
                    </div>                                            
             </div>
            ...
            <button     className="capaymentwv-paymentbtn">
                PAY NOW
            </button> 
