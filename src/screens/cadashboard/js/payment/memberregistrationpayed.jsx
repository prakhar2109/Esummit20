...
export default class Payment extends Component{
    ...
    render()
    {   
        let {isCouponValid,isPayed,registrationFee,workshops,noOfWorkshops,couponDiscountPayed,visibleAccomodationFee,noOfMembers,totalFee,discountAvailedPercent,couponDiscountPercent,totAmtPayed,datePayed} = this.state
