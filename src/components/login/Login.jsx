    ...
    return (
      <React.Fragment>
        ...
        <div className="account_setup">
          ...
          <div className="login-emailfield">E-Mail (Enter the same Email-id through which you have registered)</div>
                  <div className="login-emailinputfield">
                    ...
                    <div className="loginformSubmit" onClick={this.loginSubmit}>Login</div>
