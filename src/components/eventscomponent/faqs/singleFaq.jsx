...
class SingleFAQ extends Component {
  ...
  toggle = (e, id) => {
    ...
    if (show === 1) {
      ...
      document.getElementById(qid).style.color = 'rgba(255, 255, 255, 0.87)'
      document.getElementById(qid).style.background = '#070f12'
      ...
      document.getElementById(qid).style.background = '#070f12'
      document.getElementById(qid).style.color = 'rgba(255, 255, 255, 0.38)'
