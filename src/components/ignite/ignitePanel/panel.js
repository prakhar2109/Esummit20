...
import headingBackground from '../igniteHeader/assets/paneldiscussion.svg'
import './panel.css'
        ...
        <div className="panel-list-container">
          ...
          <div className="panel-list-card-container">
            <div className="panel-list-card">
              <img src={cardImage} alt="" className="panel-list-card-image" />
              <div className="panel-list-card-content">
                <div className="panel-list-card-heading">Kamal Bali</div>
