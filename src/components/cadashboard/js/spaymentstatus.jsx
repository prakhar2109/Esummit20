    ...
    axios
      ...
      .then(res => {
        ...
        this.setState(
          ...
          () => {
            let successList = this.state.membersList.filter(
              x => x.status === 'SUC'
            )
            this.setState({
  ...
  viewListHandler = () => {
    if (this.state.viewListIsVisible) {
      this.setState(
        ...
        () => {
          document.getElementById('cainvite-paymentstatus-viewlist').innerHTML =
            'Hide List <svg width="28" height="17" viewBox="0 0 28 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M26 15L14.0003 3L2 15" stroke="#F39423" stroke-width="3"/></svg>'
          document.getElementById('cainvite-paymentnametable').style.display =
            'block'
      ...
      this.setState(
        ...
        () => {
          document.getElementById('cainvite-paymentstatus-viewlist').innerHTML =
            'View List<svg width="28" height="17" viewBox="0 0 28 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 2L13.9997 14L26 2" stroke="#F39423" stroke-width="3"/></svg>'
          document.getElementById('cainvite-paymentnametable').style.display =
            'none'
          document.getElementById(
            'cainvite-linkparentstatic-subparent'
      ...
      <div className="cainvite-linkparent-parent-parent">
        <div id="cainvite-linkparentstatic-subparent">
          ...
          <div className="cainvite-paymentstatus-text2">
            ...
            <div
              id="cainvite-paymentstatus-viewlist"
              className="cainvite-paymentstatus-viewlist"
              onClick={this.viewListHandler}
            >
              View List
              <svg
                width="28"
        ...
        <div
          id="cainvite-paymentnametable"
          className="cainvite-paymentnametable capayment-status"
        >
          <table>
            <tr>
