...
export default class Coupon extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        {this.state.noOfCoupons
          ? couponsKey.map((coupon, i) => {
              return (
                <SingleCoupon
                  key={i}
                  cashback={couponsValue[i]}
                  couponId={couponsKey[i]}
                ></SingleCoupon>
              )
            })
          : null}
      ...
      <div className="cacoupon-parent">
        <div className="cacoupon-toprow">
          <input
            ...
            id="cacoupon-radiobtn"
            name="coupon"
            className="cacoupon-radiobtn"
            type="radio"
          ></input>
        ...
        <div className="coupon-cashback">{this.props.cashback}% Cashback</div>
        <div className="cacoupon-validtill">Valid till 2nd December 2018</div>
      </div>
    )
  }
}
