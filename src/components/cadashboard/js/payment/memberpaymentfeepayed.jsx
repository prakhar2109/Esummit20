...
import '../../css/payment/memberpaymentfeepayed.css'
      ...
      return (
        <div className="capayment-parent">
          ...
          <div className="capaymentwv-paymentinfo">
            ...
            <div className="capayment-feesleader-only">
              Workshop fees can only be payed after contingent leader has paid
            ...
            <div className="capaymentwv-totlamt">
              ...
              :<div className="capaymentwv-space"></div>Rs&nbsp;800
              {/* totalAmount */}
            </div>
          </div>
          <div className="capayment-middlerow">
            ...
            <button className="capaymentwv-paymentbtn">PAY NOW</button>
          </div>
