...
import './../../css/payment/contingentwithworkshop.css'
...
export default class Payment extends Component {
  constructor() {
    ...
    this.state = {
      ...
      couponDiscountFee: 400,
      //workshops
      noOfWorkshopsBought: 2,
      workshopsBought: [
        {
          name: 'workshop1',
          cost: 500
  ...
  toggleAccomodation = e => {
    if (this.state.isDiscarded) {
      document.getElementById(
        'capaymentwv-toggleaccomodation'
      ).style.borderColor = '#E2574C'
      document.getElementById('capaymentwv-toggleaccomodation').innerHTML =
        'DISCARD'
      document.getElementById(
        'capayment-noOfMembers'
      ).innerHTML = `x${this.state.noOfMembers}`
      this.setState(
        {
          isDiscarded: false,
        ...
        () => {
          document.getElementById(
            'capayment-accomodationfee-toggle'
          ).innerHTML = `Rs ${this.state.visibleAccomodationFee}`
        }
      )
    } else {
      document.getElementById(
  ...
  viewBillingDetails = () => {
    if (!this.state.isBillingOpen) {
      document.getElementById('capaymentwv-paymentinfodoneu').style.display =
        'none'
      document.getElementById('capaymentwv-paymentinfodonee').style.display =
        'block'
      document.getElementById(
        'capaymentwv-paymentstatusdone'
  ...
  render() {
    ...
    subTotal =
      (registrationFee + visibleAccomodationFee - couponDiscount) * noOfMembers
    totalAmount = subTotal + noOfWorkshopsNew * 500
    ...
    if (!isPayed) {
        ...
        <div className="capaymentwv-parent">
          ...
          <div className="capaymentwv-paymentinfo">
            ...
            <div className="capaymentwv-registrationfee">
              <div className="capaymentwv-spaceaboutcolon">
                Registration Fee
              </div>{' '}
              :<div className="capaymentwv-space"></div>Rs&nbsp;
              {registrationFee}
              <div className="capayment-noOfMembers">x{noOfMembers}</div>
              <div className="capaymentwv-earlybirddiscount">
                (Early Bird Discount)
              </div>
            </div>
            <div className="capaymentwv-accomodationfee">
              <div className="capaymentwv-spaceaboutcolon">
                Accomodation Fee{' '}
                <button
                  id="capaymentwv-toggleaccomodation"
                  className="capaymentwv-toggleaccomodation"
                  onClick={e => this.toggleAccomodation(e)}
                >
                  DISCARD
                </button>{' '}
              </div>{' '}
              :<div className="capaymentwv-space"></div>
              <div id="capayment-accomodationfee-toggle">
                Rs&nbsp;{visibleAccomodationFee}
              </div>
              <div className="capayment-noOfMembers" id="capayment-noOfMembers">
                x{noOfMembers}
              </div>
            </div>
            ...
            <div className="capaymentwv-discountcoupon">
              <div className="capaymentwv-spaceaboutcolon">
                Coupon Discount
                <button
                  id="capaymentwv-couponapply"
                  className="capaymentwv-couponapply"
                  onClick={e => {
                    this.toggleCoupon(e)
                  }}
                >
              ...
              :
              <dicouponDiscountPercentv className="capaymentwv-space"></dicouponDiscountPercentv>
              ...
              {isCouponValid ? (
                ...
                >
                  <div className="capaymentwv-modalparent">
                    ...
                    <input
                      className="capaymentwv-modalinputcode"
                    ...
                    <div className="capaymentwv-modalmiddlerow">
                      <hr className="capaymentwv-modalline" /> OR{' '}
                      <hr className="capaymentwv-modalline" />
                    </div>
                    <div className="capaymentwv-modallastrow">
                      <div className="capaymentwv-modallastrowheader">
                ...
                >
                  <div className="capaymentwv-modalparent">
                    <div className="capaymentwv-modallastrow">
                      <div className="capaymentwv-modallastrowheader1">
            ...
            <div className="capaymentwv-totalamt">
              <div className="capaymentwv-spaceaboutcolon1">
                Sub Total Amount
              </div>
              :<div className="capaymentwv-space"></div>Rs&nbsp;{subTotal}
            </div>
            ...
            <div className="capaymentwv-workshop-parent">
              ...
              <Payments
                workshops={workshopsNew}
                noOfWorkshops={noOfWorkshopsNew}
              />
            </div>
            <div className="capaymentwv-horizontalline"></div>
            <div className="capaymentwv-totlamt">
              <div className="capaymentwv-spaceaboutcolon-total">
                Total Amount
              </div>{' '}
              :<div className="capaymentwv-space"></div>Rs&nbsp;{totalAmount}
            </div>
          </div>
          <div className="capaymentwv-middlerow">
            ...
            <button
              ...
              className="capaymentwv-paymentbtn"
            >
              PAY NOW
            </button>
          </div>
          <div className="capaymentwv-bottomrow">
            <div className="capaymentwv-discountcriterion">
              {' '}
              Discount Criterion
            </div>
            <div className="capaymentwv-line2"></div>
      ...
      return (
        <div className="capaymentwv-parent">
          ...
          <div
            className="capaymentwv-paymentinfodoneu"
            id="capaymentwv-paymentinfodoneu"
          >
            ...
            <div className="capaymentwv-billingdetails-secondrow">
              ...
              <div
                className="capaymentwv-viewbillingdetails"
          ...
          <div
            className="capaymentwv-paymentinfodonee"
            id="capaymentwv-paymentinfodonee"
          >
            <div
              className="capaymentwv-paymentstatusdone"
              id="capaymentwv-paymentstatusdone"
            >
              <div className="capaymentwv-paymentstatusdone12">
                <svg
                  width="41"
            ...
            {/* <div className="capaymentwv-horizontalline"></div> */}
            <div className="capaymentwv-totalamt">
              <div className="capaymentwv-spaceaboutcolon12">
                Sub Total Amount
              </div>
              :<div className="capaymentwv-space"></div>Rs&nbsp;{subTotal}
            </div>
            ...
            <div className="capaymentwv-totlamt">
              ...
              :<div className="capaymentwv-space"></div>Rs&nbsp;{totAmtPayed}
            </div>
          </div>
          <div className="capaymentwv-bottomrow">
            <div className="capaymentwv-discountcriterion">
