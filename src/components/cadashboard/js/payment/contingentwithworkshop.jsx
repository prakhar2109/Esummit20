...
export default class Payment extends Component{
    ...
    toggleAccomodation = (e) =>{
        if(this.state.isDiscarded){
            ...
            document.getElementById('capayment-noOfMembers').innerHTML=`x${this.state.noOfMembers}`;
            this.setState({
                isDiscarded:false,
    ...
    render(){
        let {isCouponValid,workshopsBought,workshopsNew,noOfWorkshopsBought,noOfWorkshopsNew,couponDiscount,isPayed,registrationFee,couponDiscountFee,noOfMembers,visibleAccomodationFee,discountAvailedPercent,couponDiscountPercent,subTotal,totalAmount} = this.state
        ...
        subTotal = (registrationFee + visibleAccomodationFee - couponDiscount)*noOfMembers
             ...
             <div className="capaymentwv-paymentinfo">
                ...
                <span className="capaymentwv-span">Payment Status</span> : Pending
                 ...
                 <div className="capaymentwv-registrationfee">
                     <div className="capaymentwv-spaceaboutcolon">Registration Fee</div> :<div className="capaymentwv-space"></div>Rs&nbsp;{registrationFee}<div className='capayment-noOfMembers'>x{noOfMembers}</div><div className='capaymentwv-earlybirddiscount'>(Early Bird Discount)</div>
                 </div>
                 <div className="capaymentwv-accomodationfee">
                 <div className="capaymentwv-spaceaboutcolon">Accomodation Fee <button id="capaymentwv-toggleaccomodation" className="capaymentwv-toggleaccomodation" onClick={(e)=>this.toggleAccomodation(e)}>DISCARD</button>   </div> :<div className="capaymentwv-space"></div><div id='capayment-accomodationfee-toggle'>Rs&nbsp;{visibleAccomodationFee}</div><div className='capayment-noOfMembers' id='capayment-noOfMembers'>x{noOfMembers}</div>
                 </div>
                 
                 <div className="capaymentwv-discountcoupon">
                 
                 <div className="capaymentwv-spaceaboutcolon">Coupon Discount<button id="capaymentwv-couponapply" className="capaymentwv-couponapply" onClick={e=>{this.toggleCoupon(e)}}>APPLY</button> </div> :<dicouponDiscountPercentv className="capaymentwv-space"></dicouponDiscountPercentv><div className='capayment-viewbillingdetails-coupondiscount'>-Rs {couponDiscount}</div><div className='capayment-noOfMembers'>x{noOfMembers}</div><div className='capayment-earlybirddiscount'>(Contingent Discount)</div>
                 {isCouponValid?(
...
<path d="M20.4258 0C9.37716 0 0.425781 8.95138 0.425781 20C0.425781 31.0486 9.37716 40 20.4258 40C31.4744 40 40.4258 31.0486 40.4258 20C40.4141 8.95138 31.4627 0 20.4258 0ZM20.4258 36.3679C11.3807 36.3679 4.04617 29.0334 4.04617 19.9883C4.04617 10.9432 11.3807 3.60867 20.4258 3.60867C29.4709 3.62039 36.7937 10.9432 36.8054 19.9883C36.7937 29.0451 29.4709 36.3679 20.4258 36.3679Z" fill="#70BF48"/>
  ...
  <div className="capaymentwv-registrationfee">
                 ...
                 <div className="capaymentwv-accomodationfee">
                 <div className="capaymentwv-spaceaboutcolon">Accomodation Fee  </div> :<div className="capaymentwv-space"></div><div id='capayment-accomodationfee-toggle'>Rs&nbsp;{visibleAccomodationFeePayed}</div><div className='capayment-noOfMembers' id='capayment-noOfMembers'>x{noOfMembers}</div>
                 </div>
                 
                 <div className="capaymentwv-discountcoupon">
                 <div className="capaymentwv-spaceaboutcolon">Coupon Discount </div> :<div className="capaymentwv-space"></div><div className='capayment-viewbillingdetails-coupondiscount'>-Rs&nbsp;{couponDiscountFee}</div><div className='capayment-noOfMembers' id='capayment-noOfMembers'>x{noOfMembers}</div><div className='capayment-earlybirddiscount'>(Contingent Discount)</div>
                 </div>
                 {/* <div className="capaymentwv-horizontalline"></div> */}
                 <div className="capaymentwv-totalamt">
                 ...
                 <div className='capaymentwv-workshop-parent'>
                    ...
                    <div className="capaymentwv-horizontalline"></div>    
                    <div className='capaymentwv-totlamt'>
                        <div className="capaymentwv-spaceaboutcolon-total">Total Amount</div> :<div className="capaymentwv-space"></div>Rs&nbsp;{totAmtPayed}
                    </div>    
             </div>    
             <div className="capaymentwv-bottomrow">
                <div className="capaymentwv-discountcriterion"> Discount Criterion</div>
