...
export default class Payment extends Component {
  ...
  viewBillingDetailsbw = () => {
    if (!this.state.isBillingOpenbw) {
      document.getElementById('capaymentwvbw-paymentinfodoneu').style.display =
        'none'
      document.getElementById('capaymentwvbw-paymentinfodonee').style.display =
        'block'
      document.getElementById(
        'capaymentwvbw-paymentstatusdone'
      ).style.backgroundColor = '#FFFAF4'
    ...
    if (!isPayed) {
        ...
        <div className="capaymentwv-parent">
          ...
          <div className="capaymentwv-paymentinfo">
            ...
            <div className="capaymentwv-workshop-parent">
              ...
              <Payments
                workshops={workshopsBought}
                noOfWorkshops={noOfWorkshopsBought}
              />
            </div>
          ...
          >
            ...
            <div className="capaymentwv-discountcoupon">
              ...
              :<div className="capaymentwv-space"></div>Rs&nbsp;{couponDiscount}
      ...
      return (
        <div className="capaymentwv-parent">
          ...
          <div
            className="capaymentwv-paymentinfodoneu"
            id="capaymentwvbw-paymentinfodoneu"
          >
            <div
              className="capaymentwv-paymentstatusdone"
              id="capaymentwvbw-paymentstatusdone"
            >
              <div className="capaymentwv-paymentstatusdone12">
                <svg
                  width="41"
            ...
            <div className="capaymentwv-billingdetails-secondrow">
              ...
              <div
                className="capaymentwv-viewbillingdetailsbw"
                onClick={this.viewBillingDetailsbw}
              >
                View Billing Details
                <svg
                  width="15"
          ...
          <div
            className="capaymentwv-paymentinfodonee"
            id="capaymentwvbw-paymentinfodonee"
          >
            <div
              className="capaymentwv-paymentstatusdone"
              id="capaymentwvbw-paymentstatusdone"
            ...
            <div className="capaymentwv-totlamt">
              ...
              :<div className="capaymentwv-space"></div>Rs&nbsp;{totAmtPayedW}
            </div>
          </div>
