...
export default class Payment extends Component {
  ...
  viewBillingDetailsbw = () => {
    ...
    if (!this.state.isBillingOpenbw) {
      document.getElementById('capaymentbw-paymentinfodoneu').style.display =
        'none'
      document.getElementById('capaymentbw-paymentinfodonee').style.display =
        'block'
      document.getElementById(
        'capaymentbw-paymentstatusdone'
      ).style.backgroundColor = '#FFFAF4'
      this.setState({
        ...
        <div className="capayment-parent">
          ...
          <div className="capayment-paymentinfo">
            ...
            <div className="capayment-registrationfee">
              ...
              :<div className="capayment-space"></div>Rs {registrationFee}
            ...
            <div className="capayment-accomodationfee">
              ...
              :<div className="capayment-space"></div>
            ...
            <div className="capayment-totalamt">
              ...
              <div className="capayment-space"></div>Rs {totalFee}
            </div>
          </div>
          <div className="capayment-middlerow"></div>
      ...
      return (
        <div className="capayment-parent">
          ...
          >
            ...
            <div className="capayment-registrationfee">
              <div className="capayment-spaceaboutcolon">Registration Fee</div>{' '}
              :<div className="capayment-space"></div>Rs {registrationFeePayed}
              <div className="capayment-noOfMembers">x{noOfMembers}</div>
              <div className="capayment-earlybirddiscount">
                (Early Bird Discount)
              </div>
            ...
            <div className="capayment-accomodationfee">
              <div className="capayment-spaceaboutcolon">Accomodation Fee </div>{' '}
              :<div className="capayment-space"></div>Rs{' '}
              {visibleAccomodationFeePayed}
              <div className="capayment-noOfMembers">x{noOfMembers}</div>
            </div>
            {/* <div className="capayment-discountavailed">
            ...
            <div className="capayment-totalamt">
              <div className="capayment-spaceaboutcolon">Total Amount</div>:
              <div className="capayment-space"></div>Rs {totAmtPayed}
            </div>
          </div>
          <div
            className="capaymentwv-paymentinfodoneu"
            id="capaymentbw-paymentinfodoneu"
          >
            <div
          ...
          <div
            ...
            id="capaymentbw-paymentinfodonee"
          >
            <div
              className="capaymentwv-paymentstatusdone"
              id="capaymentbw-paymentstatusdone"
            >
              <div className="capaymentwv-paymentstatusdone12">
                <svg
                  width="41"
