...
import '../../css/payment/contingentpayment.css'
...
export default class Payment extends Component {
  ...
  render() {
    ...
    totalFee = (registrationFee - couponDiscount + visibleAccomodationFee) * 7
          ...
          <div className="capayment-paymentinfo">
            ...
            <div className="capayment-discountcoupon">
              <div className="capayment-spaceaboutcolon">
                Coupon Discount
                <button
                  id="capayment-couponapply"
                  className="capayment-couponapply"
                  onClick={e => {
                    this.toggleCoupon(e)
                  }}
                >
