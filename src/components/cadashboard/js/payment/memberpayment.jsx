...
export default class Payment extends Component{
    ...
    render()
    {   
        let {isCouponValid,isPayed,registrationFee,visibleAccomodationFee,noOfMembers,totalFee,couponDiscountPayed,couponDiscount,couponDiscountPercent,totAmtPayed,datePayed} = this.state
        ...
        totalFee = (-couponDiscount + registrationFee + visibleAccomodationFee)*noOfMembers
