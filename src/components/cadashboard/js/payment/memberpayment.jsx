...
import '../../css/payment/memberspayment.css'
...
export default class Payment extends Component {
  constructor() {
    ...
    this.state = {
      ...
      couponDiscountPercentPayed: 12,
      couponDiscountPayed: 998,
      totAmtPayed: 1860,
      datePayed: '12/12/12'
    }
  }
  ...
  render() {
    ...
    totalFee =
      (-couponDiscount + registrationFee + visibleAccomodationFee) * noOfMembers
