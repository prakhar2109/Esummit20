          ...
          <div className="cacontigent-parent">
            ...
            <div className="cacontigent-innerparent" id="createcontigent">
              <div className="cacontigent-createparent">
                <div className="cacontigent-heading" style={{ color: "rgba(255, 255, 255, 0.87)" }}>Create Contingent</div>
                <div
              ...
              >
                <div className="cacontigent-heading" style={{ color: "rgba(255, 255, 255, 0.87)" }}>Join Contingent</div>
                <div
