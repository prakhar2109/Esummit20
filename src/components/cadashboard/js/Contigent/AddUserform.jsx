    ...
    handleSubmit = index => {
      ...
      axios({
        ...
        let contingent_error_messages
          ...
          contingent_error_messages='User already a leader of a contingent'
        ...
        <div>
          <form>
            <div className="loadingUserformParent">
              {this.state.contingent_error_bool?this.state.contingent_error_messages:null}
              {/* {this.state.Es_id_error?this.state.error_bool:null} */}
              <p id="loadingUserform" style={{display:"none"}}>Please Wait</p>
            </div>
