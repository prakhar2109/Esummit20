    ...
    return (
      <div className="header">
        ...
        <span className="links">
          ...
          <NavLink target="_blank" to="/ideastorm">
            Idea Storm{' '}
          </NavLink>
        </span>
