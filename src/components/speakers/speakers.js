...
import coming from '../../assets/speakers/coming-speaker.png'
import harish from '../../assets/speakers/harsh-hande.jpeg'
        ...
        <div className="speakers-page-section-card-container">
          <div className="speakers-page-section-card">
            ...
            <div className="speakers-page-section-card-content">
              <div className="speakers-page-section-card-heading">
                Karthik Reddy
              </div>
          ...
          <div className="speakers-page-section-card">
            ...
            <div className="speakers-page-section-card-content">
              ...
              <div className="speakers-page-section-card-subheading"></div>
            </div>
          </div>
        </div>
      </div>
