      ...
      <div>
        <div className="esummit-register-form-body-parent">
          ...
          <div className="esummit-register-form-orsection">
            <div className="esummit-register-form-orsection-hr">
              <hr />
            </div>
            <span>OR</span>
            <div className="esummit-register-form-orsection-hr-s">
              <hr />
            </div>
          </div>
              ...
              <div className="esummit-register-form-input-specific">
                ...
                <div className="esummit-register-form-input-specific-eye">
                  <input
                    ...
                    required
                  />
                  <span onClick={this.handleConfirmToggle}>
                    <img
                      alt="images"
                      className="esummit-register-form-input-specific-eye-svg"
                      src={!toggleConfirmEye ? eye : color_eye}
                    />
                  </span>
                  <span className="esummit-register-form-field-error-svg">
