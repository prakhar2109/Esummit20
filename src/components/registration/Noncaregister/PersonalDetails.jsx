...
class PersonalDetails extends Component {
  ...
  handleSubmit = () => {
    ...
    if (
      ...
      this.state.profile_type === 'iitr_student'
    ) {
    ...
    if (
      ...
      (this.state.profile_type === 'non_iitr_student' ||
        this.state.profile_type === 'ca' ||
        this.state.profile_type === 'professor')
    ) {
    ...
    if (
      this.state.college === '' &&
      this.state.profile_type !== 'iitr_student' &&
      this.state.profile_type !== 'professional'
    ) {
  ...
  getTshirt = () => {
    return tshirt_option.map(tshirt => ({
      value: tshirt.name,
      label: tshirt.name
    }))
  }
  ...
  enrollvalidate = () => {
    setTimeout(
      function() {
        if (
          this.state.enrollment_no.length < 8 ||
          this.state.enrollment_no.length > 8
        ) {
          this.setState({
        ...
        <div>
          <div>
                  ...
                  <div className="esummit-register-form-input-specific">
                    ...
                    <div className="esummit-register-form-input-specific-inner">
                      <CreatableSelect
                        ...
                        options={
                          states === '' ? [] : this.getCities(states.value)
                        }
                        clearable={false}
                        value={city}
                      />
            ...
            {profile_type !== 'iitr_student' ? (
              <div>
                <div className="esummit-register-form-input-specific">
                  <label htmlFor="inputAboutEsummit">
                    HOW DO YOU KNOW ABOUT ESUMMIT?
                  </label>
                  <div className="esummit-register-form-input-specific-inner">
                    <Select
                      styles={custom_styles}
