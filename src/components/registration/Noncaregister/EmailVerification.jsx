    ...
    return (
      <div className="esummit-register-form-body-parent">
        {resend_otp ? null : (
          <div>
            {!otp_expired ? (
              <div className="esummit-register-form-message-verification">
                OTP has been successfully sent to your email.
              </div>
            ) : (
              <div className="esummit-register-form-message-verification">
                <span style={{ color: '#cb4c4c', fontSize: '13px' }}>
                  OTP is expired.
                </span>{' '}
                Click on resend otp to resend the one time password
              </div>
            )}
          </div>
        )}
            ...
            <div className="esummit-register-form-input-specific">
              ...
              {!otp_expired ? (
                <div className="esummit-register-form-timer">
                  0{parseInt(this.state.time / 60)}:
                  {this.state.time % 60 < 10 ? '0' : null}
                  {this.state.time % 60}
                </div>
              ) : null}
            </div>
            <div
              className="esummit-register-form-resend-otp-field"
